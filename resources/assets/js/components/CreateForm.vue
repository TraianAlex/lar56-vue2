            ...
            <form class="mt-3" :method="method" :src="url" @submit.prevent="onSubmit"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="author" aria-describedby="gibberishAuthor"
                           placeholder="for ex. Batman (Brolo Waynolo)" v-model="form.author" name="author">
                    <span class="help is-danger" v-if="form.errors.has('author')" v-text="form.errors.get('author')"></span>
                </div>
                <div class="form-group">
                    <label for="cite">Password</label>
                    <input type="text" class="form-control" id="cite" placeholder="Never loot a gibbet." v-model="form.cite"
                           name="cite">
                    <span class="help is-danger" v-if="form.errors.has('cite')" v-text="form.errors.get('cite')"></span>

                </div>
                <div class="form-group">
                    <label for="date">Password</label>
                    <input type="date" class="form-control" id="date" placeholder="1667-02-02" v-model="form.date"
                           name="date">
